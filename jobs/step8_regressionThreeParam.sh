...
" | sbatch --account $RAP_ID --chdir $PWD --time 0-12:00:00 --ntasks $workers --cpus-per-task 20 \
...
#runPBS "-r 1 -a SGD -p e4000 "
#runPBS "-n -r 1 -a SGD -p e4000 "
#runPBS "-r 1250 -a SGD -p e4000 "
runPBS "-r 500 -a Adam -p e500pep9t5 -x 3 "
